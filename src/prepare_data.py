...
subprocess.check_call([sys.executable, "-m", "conda", "install", "-c", "pytorch", "pytorch==1.6.0", "-y"]) # uncomment this row for data processing, comment it for local testing

subprocess.check_call([sys.executable, "-m", "conda", "install", "-c", "conda-forge", "transformers==3.5.1", "-y"]) # uncomment this row for data processing, comment it for local testing
# from transformers import RobertaTokenizer
from transformers import AutoTokenizer, AutoConfig # https://huggingface.co/cardiffnlp/twitter-roberta-base-sentiment-latest
